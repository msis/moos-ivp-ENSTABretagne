...
Mission::Mission(string nomFichierMission)
{
	m_iterations = 0;
	m_timewarp   = 1;
}
...
bool Mission::OnNewMail(MOOSMSG_LIST &NewMail)
{
...
bool Mission::OnConnectToServer()
{
...
void Mission::RegisterVariables()
{
